...
exports.login = async (req, res) => {
  try {
    ...
    if (!reg.user) {
      ...
      const token = jwwt.sign({ id: req.user._id }, process.env.SECRET);
...
exports.updateUser = async (req, res) => {
  try {
    const result = await User.updateOne(reg.body.filterObj, reg.body.updateObj);
    /*{username: "LizyO"} {keyName: "value"}*/
